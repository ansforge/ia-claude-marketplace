...
Plugins développés et maintenus par l'ANS. Installez-les directement depuis Claude Code :
...
## Compétences IA curatives

Une sélection des meilleures compétences IA disponibles, issues de Claude Code ou d'autres sources de confiance.
...
.hero-lead { font-size: 1.15rem; line-height: 1.7; max-width: 760px; }
...
.why-card p { font-size: 0.9rem; color: #495057; margin: 0; line-height: 1.6; }
...
.skill-card:hover { box-shadow: 0 4px 16px rgba(0,0,0,0.1); transform: translateY(-2px); }
.skill-card--internal { border-top: 3px solid #0053b3; }
.skill-card--curated { border-top: 3px solid #005e46; }

.skill-header { display: flex; align-items: flex-start; gap: 1rem; }
.skill-icon { font-size: 1.75rem; line-height: 1; flex-shrink: 0; margin-top: 2px; }
.skill-title { font-size: 1rem; font-weight: 700; margin: 0 0 0.2rem; }
...
.skill-command { font-size: 0.8rem; color: #6c757d; background: #f1f3f5; padding: 0.1rem 0.35rem; border-radius: 3px; }

.skill-desc { font-size: 0.88rem; color: #495057; margin: 0; line-height: 1.6; flex: 1; }
